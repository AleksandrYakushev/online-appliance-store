...
GO
ALTER TABLE [dbo].[Order] DROP CONSTRAINT [FK__Order__CustomerI__4D94879B];
...
GO
ALTER TABLE [dbo].[Order] ALTER COLUMN [CustomerID] BIGINT NULL;
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Order'))
               AND [type] IN (N'F', N'C')
