...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Order] ([Id], [ProductID], [Count])
        SELECT   [Id],
                 [ProductID],
                 [Count]
        FROM     [dbo].[Order]
...
GO
PRINT N'Creating unnamed constraint on [dbo].[OrderHistory]...';
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Order'), OBJECT_ID(N'dbo.OrderHistory'))
               AND [type] IN (N'F', N'C')
